 ...
 */
/**
 * The class is represents a protocol for the messages that server and client
 * send and receive.<br>
...
public class Protocol {
	 ...
	 * 
	 * @param message
	 *            is a String message that created by
	 *            {@link #createMessage(int, String, String)}
	 ...
	 * 
	 * @param type
	 *            the tyep of the sending message.
	 * @param from
	 *            from whom sent the message (username).
	 * @param message
	 *            the sending message.
	 ...
	 * The answer can be success when the connection established
	 * successfully<br>
	 * or fail when the requested username is in use by other user.
	 * 
	 * @param ParsedMessage - String message parsed by {@link Protocol#parseMessage(String)}
	 * @param answer
	...
	public static String[] parseMessage(String message) {
		...
		case connectRequestMessage:
			...
			// res[2] the message from server (like try to choose another
			// username)
